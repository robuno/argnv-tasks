...
<body>
    <div id="blog-photo-head">
        <div id="blog-header-text">
            <h3>Servo Project Linux Fold Desco'ya Katıldı</h3>
            <p><a href="" >Ana Sayfa </a><a href="index.php" >/ Blog </a><a href="" >/ IT Hizmetleri </a>/ Servo Project Linux Fold Desco'ya Katıldı</p>   
        </div>
