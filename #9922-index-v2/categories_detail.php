<?php 
    ...
    $queryname = "SELECT categoryname FROM categoriesdb WHERE id='$id' ORDER BY ID ASC";
...
<html>
<head>
    <title><?php echo $categoryname ?> Kategorisi</title>
...
<body>
    <div id="blog-photo-head">
        <div id="blog-header-text">
            <h3>Kategoriler</h3>
            <p>Kategoriler/ <?php echo $categoryname ?></p>   
        </div>

        <img src="https://www.alten.com/wp-content/uploads/2018/08/services-header.jpg" alt="LatestPostImg">
    </div>
<div class="container" id="blog-all-containers">
    <div class="row">
        <div class="col-md-8" id="posts-left" >
            ...
            <?php
            $query = "SELECT * FROM datacontent WHERE categoryID='$id' ORDER BY ID ASC ";
            ...
            while($row = mysqli_fetch_array($result))
                {
                    ...
                    <div id="blog-post-img">
                        ...
                        <a href="categories_detail.php?id='.$row["categoryID"].'"><div id="blog-img-button">        
                        '.getNameofRow("SELECT categoryname FROM categoriesdb WHERE id='$categoryID'").'
                        </div></a>
                    </div>
