...
<body>
    ...
    <div class= "container" id="new-user-container">
        <div class="row justify-content-center">
            <?php 
                    if ($action=='duzenle') {
                        $goster = mysqli_query($conn, "SELECT * FROM brands WHERE id='$id' ");
                        ...
                        echo '
                        <form action="dashboard_brands.php" method="POST">
                    ...
                    {
                        $guncelle = "UPDATE brands SET
                        brands.title = '$title',
                        brands.imglink = '$imglink'
                        WHERE brands.id = '$id'
                        ";
                    ...
                    {
                        $kaydet = "INSERT INTO brands (title, imglink) VALUES('$title', '$imglink')";
    ...
    <div class="container" id="table-new-user">
        <div class="row">
            <!-- <div class="col"> -->
                <a href="dashboard_brands.php?action=yeni"><button class="btn btn-primary">Yeni Marka</button></a>            
                <?php
                    tableShowBrands();
                ?>   
            <!-- </div> -->
