<nav class="navbar navbar-expand-lg navbar-dark " id="navbar2cms">
  ...
  <div class="collapse navbar-collapse" id="navbarNavCMS">
    <ul class="navbar-nav">
      ...
      <li class="nav-item<?php if($file == 'dashboard_category.php') {echo ' active';} ?>">
        <a class="nav-link" href="dashboard_category.php">Kategoriler</a>
      </li>
      ...
      <li class="nav-item<?php if($file == 'dashboard_projects.php') {echo ' active';} ?>">
        <a class="nav-link" href="dashboard_projects.php">Projeler</a>
      </li>
      <li class="nav-item<?php if($file == 'dashboard_prices.php') {echo ' active';} ?>">
        <a class="nav-link" href="dashboard_prices.php">Paketler</a>
      </li>
      <li class="nav-item<?php if($file == 'dashboard_brands.php') {echo ' active';} ?>">
        <a class="nav-link" href="dashboard_brands.php">Markalar</a>
      </li>
