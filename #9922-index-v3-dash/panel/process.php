    ...
    <table id="user_name_data" class="table table-striped table-bordered">
        <thead>
            <tr>
                ...
                <td>Paket Adı</td>
                <td>Fiyatı</td>
                <td>Genişletilmiş Yönetici Paneli</td>
                <td>Çoklu Dil Desteği</td>
                <td>E-mail, Telefon Desteği</td>
                <td>İçerik Yönetim Hizmeti</td>
                <td>İşlemler</td>
            </tr>
        </thead>';
    ...
    while($row = mysqli_fetch_array($result))
        {
            echo '
                <tr>
                    ...
                    <td>'.$row["title"].'</td>
                    <td>'.$row["price"].'</td>
                    <td>'.ucfirst($row["expanel"]).'</td>
                    <td>'.ucfirst($row["multilang"]).'</td>
                    <td>'.ucfirst($row["support"]).'</td>
                    <td>'.ucfirst($row["cmservice"]).'</td>
    ...
    while($row = mysqli_fetch_array($result))
        {
            echo '
                <tr>
                    ...
                    <td>'.$row["title"].'</td>
                    <td>'.$row["imglink"].'</td>
                    <td><a href="dashboard_brands.php?action=duzenle&id='.$row["id"].'"><i class="far fa-edit"></i>Düzenle</a><a href="dashboard_brands.php?action=sil&id='.$row["id"].'" id="remove-icon"><i class="far fa-trash-alt"></i>Sil</a></td>
                </tr>
            ';
        }
        echo '            </table>
