            ...
            <?php 
                ...
                <div class="prices-card">
                    ...
                    <div class="price-content-item">
                        <div class="price-single-item"><p>Genişletilmiş Yönetici Paneli</p>'.getPriceIcon($row["expanel"]).'</div>
                        <div class="price-single-item"><p>Çoklu Dil Desteği</p>'.getPriceIcon($row["multilang"]).'</div>
                        <div class="price-single-item"><p>E-mail, Telefon Desteği</p>'.getPriceIcon($row["support"]).'</div>
                        <div class="price-single-item"><p>İçerik Yönetim Hizmeti</p>'.getPriceIcon($row["cmservice"]).'</div>
                    </div>
    ...
    <div class="container" id="brands">
        <div class="row" id="brands-row">
            <?php 
                ...
                $query = "SELECT * FROM  brands ORDER BY ID ASC LIMIT 6"; 
                $result = mysqli_query($conn, $query); 
                while($row = mysqli_fetch_array($result) ) {
                    ...
                    <div class="col-2"> 
                        <div class="brand-logo-img">
                            <img src="'.$row["imglink"].'" alt="'.strtolower($title).'">
                        </div>
                    </div>'; 
                }
