            ...
            <?php 
                    if ($action=='duzenle') {
                        ...
                        <div class="form-group">
                            ...
                            <h5>Anahtar kelimelerde Türkçe karakter kullanmayınız.</h5>
                    ...
                    {
                        $kaydet = "INSERT INTO datacontent (title, content, imglink, keywords) VALUES('$title', '$content', '$imglink', '$keywords')";
